...
At $0^\circ$ no transform is applied, while at $90^\circ$ all four transforms produce a single planewave originating from the specified direction.
If the unprocessed sound field is composed of multiple sources originating from many directions, these transforms do not tend to change the overall sound level of the signal, but the composition in space can be sculpted.
