...
In a similar way DirectX can be used for development of Windows-only plugins \cite{microsoft2014:directX}.
...
The model of the ATK is a sound-field sound-image model rather than a sound-object sound-scene model.
