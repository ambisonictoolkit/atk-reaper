...
These plugins use the ambiX encoded signal convention; full 3D, ACN channel ordering and\linebreak SN3D normalization \cite{Nachbar:2011ambix} as discussed in section~\ref{sec:coordinate-systems}, but also provides a plugin for conversions to other formats.
